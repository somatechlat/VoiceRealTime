              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-accent">Special Delivery</span>
                  </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-mono-900 dark:text-mono-100">Latest Mails</h2>
              </div>
              ...
              {regularPosts.map((post) => (
                <div key={post.slug} className="relative">
                  <div className="absolute -top-2 right-4 transform rotate-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-accent/60" viewBox="0 0 20 20" fill="currentColor">
