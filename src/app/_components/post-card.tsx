      ...
      <div className={`flex flex-col bg-white dark:bg-mono-800 rounded-lg h-full 
        ...
        <div className="flex flex-col p-5 h-full border-x-2 border-b-2 border-mono-200 dark:border-mono-700 rounded-b-lg">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <div className="text-xs font-mono italic text-mono-500 dark:text-mono-400 
                -rotate-3 font-semibold" style={{ fontFamily: 'cursive, sans-serif' }}>
              #{slug.substring(0, 4)}
            </div>
          </div>
          ...
          <div className="border-b border-dashed border-mono-300 dark:border-mono-600 pb-2 mb-4">
            <div className="text-xs text-mono-600 dark:text-mono-400" style={{ fontFamily: 'cursive, sans-serif' }}>
              From: {author.name}
            </div>
          </div>
          
          {/* Stamp with rough edges */}
          <div className="absolute top-3 right-3 w-14 h-14 bg-mono-100 dark:bg-mono-700 
              border-2 border-dashed border-mono-400 dark:border-mono-500
              rotate-6 flex items-center justify-center transform">
            <div className={`w-10 h-10 ${stripeColor} rounded-sm flex items-center justify-center text-white text-opacity-90`}>
