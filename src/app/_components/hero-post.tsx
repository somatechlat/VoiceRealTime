  ...
  return (
    <section className="pb-4">
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-12 gap-6 group">
        ...
        <div
          className="absolute -top-8 -right-2 md:-top-10 md:-right-6 w-24 h-24 md:w-32 md:h-32 z-10
          flex items-center justify-center transform rotate-[8deg]"
        >
          <div
            className="absolute inset-0 bg-white dark:bg-mono-800 border-4 border-dashed border-mono-300 dark:border-mono-600 
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div
                className="text-sm md:text-base font-black text-white dark:text-white bg-mono-800/60 dark:bg-mono-900/60 
                px-2 rounded-full mb-1"
              >
                FEATURED
              </div>
              <div className="text-xs md:text-sm text-white dark:text-white bg-mono-800/60 dark:bg-mono-900/60 px-2 rounded-full">
                POST
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-5 relative aspect-[4/3] transform md:rotate-[-1deg]">
          <div
            className="absolute inset-0 border-8 border-white dark:border-mono-800 rounded-lg overflow-hidden
          ...
          >
            ...
            <div
              className="absolute bottom-3 left-3 w-20 h-20 rounded-full 
        ...
        <div className="md:col-span-7 relative transform md:rotate-[1deg]">
          <div
            className="h-full border-4 border-mono-200 dark:border-mono-700 rounded-lg p-6 
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div
                className="text-xs italic text-mono-500 dark:text-mono-400"
                style={{ fontFamily: "cursive, sans-serif" }}
              >
                Special Delivery
              </div>
            ...
            <div
              className="absolute bottom-4 right-8 w-12 h-12 rounded-full 
