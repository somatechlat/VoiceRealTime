      ...
      >
        ...
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-12 h-12 z-10 overflow-hidden">
            <div
              className={`${stripeColors[colorIndex % stripeColors.length]} w-16 h-16 rotate-45 -translate-x-8 -translate-y-8`}
            ></div>
          </div>
          <div className="absolute top-0 right-0 w-12 h-12 z-10 overflow-hidden">
            <div
              className={`${stripeColors[(colorIndex + 2) % stripeColors.length]} w-16 h-16 rotate-45 translate-x-8 -translate-y-8`}
            ></div>
          </div>
          ...
          <div className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none opacity-30 z-10">
            <div
              className={`absolute ${hashCode % 2 === 0 ? "top-3 left-[40%]" : "top-5 left-[30%]"} w-24 h-24 border-4 border-dashed rounded-full ${stripeColor} opacity-40`}
            ></div>
            <div
              className={`absolute ${hashCode % 2 === 0 ? "bottom-4 right-[20%]" : "bottom-6 right-[35%]"} w-16 h-16 border-4 border-dashed rounded-full ${stripeColor} opacity-30`}
            ></div>
          </div>
          ...
          <div className="absolute top-3 right-3 w-14 h-14 z-10">
            <div className="w-full h-full bg-white/80 dark:bg-mono-900/80 border border-dashed border-mono-400 p-1">
              <div
                className={`w-full h-full ${stripeColor} flex items-center justify-center`}
              >
        ...
        <div className="p-4 border-x-2 border-b-2 border-mono-200 dark:border-mono-700">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <div
              className="text-xs italic text-mono-500 dark:text-mono-400 -rotate-2"
          ...
          {/* Title */}
          <h3
            className="text-base font-medium mb-2 text-mono-800 dark:text-mono-200"
            style={{ fontFamily: "cursive, sans-serif" }}
          >
            <Link
              href={`/posts/${slug}`}
